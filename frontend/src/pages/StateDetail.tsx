...
import {
    ...
    getRestaurantsByStateAndCuisine,
    ...
    useEffect(() => {
        if (state) {
            if (activeCuisine === "all") {
                ...
                setRestaurants(
                    getRestaurantsByStateAndCuisine(state.name, activeCuisine)
                );
            }
        }
    }, [state, activeCuisine]);
    ...
    return (
        <div>
            <Breadcrumbs
                items={[
                    { label: "Home", href: "/" },
                    { label: state.name, href: `/usa/${state.slug}` },
                ]}
            />
                    ...
                    <div className="flex items-start">
                        ...
                        <div>
                            ...
                            <p className="text-lg text-gray-100 max-w-3xl">
                                ...
                                {state.name}. From authentic halal Mexican,
                                Chinese, and Indian cuisines to Mediterranean,
                                American, and fusion dishes - all prepared
            ...
            <section className="container mx-auto px-4 py-12">
                ...
                <div id="about" className="bg-gray-50 rounded-lg p-8 mb-12">
                    ...
                    <p className="text-gray-600 mb-4">
                        {state.name} offers a diverse range of halal dining
                    ...
                    <p className="text-gray-600 mb-4">
                        Many restaurants in {state.name} now offer halal
                        ...
                        restaurants, the halal food scene in {state.name}{" "}
